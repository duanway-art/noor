...
window.NoorI18n = {
  ...
  en: {
    ...
    "wechat.body":
      "WeChat cannot open the App Store directly. Tap ··· at the top right, choose “Open in Browser”, then download Noor from the App Store.",
    "wechat.copy": "Copy App Store link",
  ...
  ar: {
    ...
    "wechat.body":
      "لا يمكن لـ WeChat فتح App Store مباشرة. اضغط ··· أعلى اليمين واختر «فتح في المتصفح» ثم نزّل نور.",
    "wechat.copy": "نسخ رابط App Store",
  ...
  "zh-Hans": {
    ...
    "wechat.body":
      "微信内无法直接跳转 App Store。请点击右上角 ···，选择「在浏览器中打开」，即可下载 Noor。",
    "wechat.copy": "复制 App Store 链接",
    "wechat.copied": "链接已复制",
    "wechat.dismiss": "知道了",
  ...
  "zh-Hant": {
    ...
    "wechat.body":
      "微信內無法直接跳轉 App Store。請點擊右上角 ···，選擇「在瀏覽器中開啟」，即可下載 Noor。",
    "wechat.copy": "複製 App Store 連結",
    "wechat.copied": "連結已複製",
    "wechat.dismiss": "知道了",
  ...
  id: {
    ...
    "wechat.body":
      "WeChat tidak bisa membuka App Store langsung. Ketuk ··· di kanan atas, pilih “Buka di Browser”, lalu unduh Noor.",
    "wechat.copy": "Salin tautan App Store",
  ...
  ms: {
    ...
    "wechat.body":
      "WeChat tidak boleh membuka App Store terus. Ketik ··· di atas kanan, pilih “Buka dalam Pelayar”, kemudian muat turun Noor.",
    "wechat.copy": "Salin pautan App Store",
  ...
  tr: {
    ...
    "wechat.body":
      "WeChat App Store'u doğrudan açamaz. Sağ üstteki ··· simgesine dokunun, “Tarayıcıda Aç”ı seçin ve Noor'u indirin.",
    "wechat.copy": "App Store bağlantısını kopyala",
  ...
  ur: {
    ...
    "wechat.body":
      "WeChat براہ راست App Store نہیں کھول سکتا۔ اوپر دائیں ··· پر تھپتھپائیں، «براؤزر میں کھولیں» منتخب کریں، پھر Noor ڈاؤن لوڈ کریں۔",
    "wechat.copy": "App Store لنک کاپی کریں",
  ...
  hi: {
    ...
    "wechat.body":
      "WeChat सीधे App Store नहीं खोल सकता। ऊपर दाएँ ··· पर टैप करें, “ब्राउज़र में खोलें” चुनें, फिर Noor डाउनलोड करें।",
    "wechat.copy": "App Store लिंक कॉपी करें",
  ...
  bn: {
    ...
    "wechat.body":
      "WeChat সরাসরি App Store খুলতে পারে না। উপরে ডানদিকে ··· ট্যাপ করুন, “ব্রাউজারে খুলুন” বেছে নিন, তারপর Noor ডাউনলোড করুন।",
    "wechat.copy": "App Store লিংক কপি করুন",
